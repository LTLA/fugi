...
#'
#' This function creates a \linkS4class{GenomicInteractions} object representing interactions 
...
#'
#' @param x a \linkS4class{GenomicInteractions} object which is output from viewPoint
